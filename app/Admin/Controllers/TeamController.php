...
class TeamController extends AdminController
{
    ...
    protected function grid(): Grid
    {
        ...
        $grid->column('image', __('admin.profile_picture'))->lightbox(['zooming' => true, 'class' => ['thumbnail', 'rounded']])->default("<img class='img img-thumbnail img-thumbnail' src='".asset('assets/images/default-pfp.png')."' width='200' height='200' />");
