	...
	<div class="row flex-column flex-lg-row align-items-center justify-content-between">
		<div class="col-lg-5 flex-grow-1 order-1 order-lg-0 mt-5 mt-lg-0">
			<div data-aos="fade-right" data-aos-duration="1500">
				...
				<p class="text-muted fs-6 leads">The largest exporter of spice and spice items. Spices is Indonesia's fourth largest export commodity, after shrimp, fish and coffee. As one of the world's spice producers, Indonesia has a great opportunity as a supplier of the world's spices to contribute to the Indonesian economy.</p>
				<p class="text-muted fs-6 leads">Spices is a plant species that has a strong taste and aroma and also serves as a flavor and food flavor enhancer.</p>
			</div>
		</div>
	...
	<div class="row flex-column flex-lg-row align-items-center justify-content-between">
		...
		<div class="col-lg-5 flex-grow-1">
			<div data-aos="fade-left" data-aos-duration="1500">
				...
				<p class="text-muted fs-6 leads">Indonesia's main export products for spices are nutmeg, cloves, white pepper, cinnamon, and cardamom, with the majority of its importers being the United States, China, India, Vietnam, and the Netherlands.</p>
			</div>
		</div>
	</div>
	<svg class="position-absolute" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" style="left: 0; bottom: 0; z-index: -1">
			...
			<div class="col-12 col-lg-4">
				<div class="bg-image hover-overlay rounded mb-4 mb-lg-0" data-aos="fade-in" data-aos-duration="1000" data-aos-delay="100">
					...
					<div class="position-absolute bottom-0 start-0 text-light p-4">
						...
						<p class="mb-0" style="text-shadow: 1px 1px #000">Founder</p>
					</div>
				</div>
			</div>
			<div class="col-12 col-lg-4">
				<div class="bg-image hover-overlay rounded mb-4 mb-lg-0" data-aos="fade-in" data-aos-duration="1000" data-aos-delay="200">
					...
					<div class="position-absolute bottom-0 start-0 text-light p-4">
						...
						<p class="mb-0" style="text-shadow: 1px 1px #000">Co-Founder</p>
					</div>
				</div>
			</div>
			<div class="col-12 col-lg-4">
				<div class="bg-image hover-overlay rounded" data-aos="fade-in" data-aos-duration="1000" data-aos-delay="300">
					...
					<div class="position-absolute bottom-0 start-0 text-light p-4">
						...
						<p class="mb-0" style="text-shadow: 1px 1px #000">Product Manager</p>
					</div>
				</div>
			</div>
		</div>
...
<section id="contact" class="py-5 px-3 p-lg-5 text-center">
	<div class="p-lg-5">
		...
		<hr class="opacity-100 mx-auto rounded mb-4" style="border-top: 4px solid #5FAC00; width: 100px" />
		<div class="d-flex flex-column flex-lg-row align-items-center justify-content-center gap-3">
			<div class="card border border-1 shadow-0" style="width: 18rem" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="100">
				<div class="card-body">
			...
			<div class="card border border-1 shadow-0" style="width: 18rem" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="200">
				<div class="card-body">
			...
			<div class="card border border-1 shadow-0" style="width: 18rem" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="300">
				<div class="card-body">
