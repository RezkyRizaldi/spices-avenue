...
@section('title', config('app.name') . ' | Post Details')

@section('content')
<div id="whatsapp" title="WhatsApp"></div>
<article id="blogDetail" class="p-lg-5" data-aos="fade-in">
	<div class="border">
		<img class="d-block mx-auto" src="{{ asset('assets/images/blog1.jpeg') }}" alt="Blog image" />
	</div>
	...
	<div>
		...
		<p class="lead">Source: <a href="#" target="_blank">https://www.businesswire.com/news/home/20220714005527/en/Insights-on-the-Seasoning-Spices-Global-Market-to-2030—Featuring-Ajinomoto-Associated-British-Foods-and-Kerry-Among-Others—ResearchAndMarkets.com</a></p>
		<hr />
		...
		<section id="#respond">
			...
			<form action="" method="POST">
				...
				<button type="submit" class="btn btn-primary">Post Comment <i class="fa-solid fa-angles-right"></i></button>
			</form>
		</section>
	</div>
</article>
